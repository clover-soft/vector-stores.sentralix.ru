...
class OpenAIProvider(BaseProvider):
    def __init__(
        ...
        if not api_key or not isinstance(api_key, str):
            raise ValueError("Для провайдера openai требуется credentials.api_key")

        base_url = connection.base_url or credentials.get("base_url")
    ...
    def create_vector_store(
        ...
        *,
        ...
        created = self._client.vector_stores.create(
            name=name,
    ...
    def update_vector_store(
        ...
        *,
        ...
        vs = self._client.vector_stores.update(
            vector_store_id,
            name=name,
            expires_after=expires_after,
            metadata=metadata,
    ...
    def attach_file_to_vector_store(
        ...
        *,
        ...
        created = self._client.vector_stores.files.create(
            vector_store_id,
            file_id=file_id,
